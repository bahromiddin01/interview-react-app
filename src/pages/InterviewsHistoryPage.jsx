            ...
            <div className={`flex mx-auto h-screen 4xl:container ${isOpen ? 'blur-[1px]' : ''}`}>
                ...
                <div className='flex flex-col flex-grow gap-8 mx-12 my-16'>
                    <div className='flex flex-col gap-8 max-w-lg'>
                        <h3 className='font-inter font-semibold text-3xl'>Past interviews</h3>
                        <div>
                            <button
                                ref={buttonRef}
                    ...
                    <div className='flex flex-col gap-4'>
                        <h4 className='font-inter font-medium text-xl'>Interviews history</h4>
